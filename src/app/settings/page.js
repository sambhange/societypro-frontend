...
// ── Moved OUTSIDE main component — fixes the typing bug ──────────────────────
  ...
  return (
    <div style={{ display:'grid', gridTemplateColumns:'220px 1fr', gap:20 }}>
      ...
      <div className="card" style={{ padding:'10px 0', height:'fit-content', marginBottom:0 }}>
        <div style={{ padding:'8px 16px 10px', fontSize:11, color:'var(--muted)',
          fontWeight:600, textTransform:'uppercase', letterSpacing:'0.8px' }}>Settings</div>
        {TABS.map(t => {
          const Icon = t.icon;
          return (
        ...
        {tab === 'account' && (
          <div className="card">
            ...
            <div className="form-grid-2">
              ...
              <Field label="Role"          value={account.role}  onChange={() => {}} disabled/>
            </div>
            <button className="btn btn-primary" onClick={showSaved}>
          ...
          <div className="card">
            ...
            <div style={{ maxWidth:420 }}>
              ...
              {password.newPw && password.confirm && password.newPw !== password.confirm && (
                <div style={{ fontSize:12, color:'var(--red)', marginBottom:12 }}>❌ Passwords do not match</div>
              )}
              {password.newPw && password.confirm && password.newPw === password.confirm && (
                <div style={{ fontSize:12, color:'var(--accent)', marginBottom:12 }}>✅ Passwords match</div>
              )}
          ...
          <div className="card">
            ...
            <div style={{ marginBottom:20 }}>
              <div style={{ fontSize:12, color:'var(--muted)', fontWeight:600,
                textTransform:'uppercase', letterSpacing:'0.8px', marginBottom:10 }}>Alert Types</div>
            ...
            <div>
              <div style={{ fontSize:12, color:'var(--muted)', fontWeight:600,
                textTransform:'uppercase', letterSpacing:'0.8px', marginBottom:10 }}>Notification Channels</div>
        ...
        {tab === 'billing' && (
          <div>
            <div className="card" style={{ marginBottom:16 }}>
              ...
              <div style={{ display:'flex', gap:16, alignItems:'center',
                ...
                <div>
                  ...
                  <div style={{ fontSize:13, color:'var(--muted)', marginTop:4 }}>
                    ₹40 per flat × 48 flats = ₹1,920/month
                  </div>
              ...
              {['✅ Dashboard + Analytics','✅ Tenant + Maintenance + Payments',
                '✅ Announcements + Meetings','✅ SMS Alerts (100 free/month)',
                '✅ Visitor + Parking + Complaints','✅ Forum + Polls + Committee',
