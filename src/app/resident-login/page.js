...
export default function ResidentLogin() {
  ...
  const handleLogin = async () => {
    ...
    const resident = RESIDENTS.find(r => r.email===form.email && r.password===form.password);
    if (resident) {
  ...
  return (
    <div style={{ minHeight:'100vh', background:'linear-gradient(135deg,#EFF6FF 0%,#F8FAFC 50%,#F0FDF4 100%)',
      display:'flex', alignItems:'center', justifyContent:'center', padding:24, fontFamily:'DM Sans,sans-serif' }}>
      <div style={{ width:'100%', maxWidth:420 }}>

        <div style={{ textAlign:'center', marginBottom:32 }}>
          <div style={{ width:64, height:64, borderRadius:16, background:'#2563EB',
            display:'flex', alignItems:'center', justifyContent:'center', margin:'0 auto 16px',
            boxShadow:'0 8px 24px rgba(37,99,235,0.3)' }}>
            <Building2 size={32} color="white"/>
          </div>
          <div style={{ fontWeight:800, fontSize:24, color:'#0F172A' }}>Resident Portal</div>
          <div style={{ fontSize:13, color:'#64748B', marginTop:4 }}>Sunrise Residency</div>
        </div>

        <div style={{ background:'white', borderRadius:20, padding:32,
          boxShadow:'0 4px 24px rgba(0,0,0,0.08)', border:'1px solid #E2E8F0' }}>

          <div style={{ fontWeight:700, fontSize:18, color:'#0F172A', marginBottom:6 }}>Welcome back! 👋</div>
          <div style={{ fontSize:13, color:'#64748B', marginBottom:24 }}>Login with your registered email</div>

          <div style={{ marginBottom:14 }}>
            <label style={{ display:'block', fontSize:11, color:'#64748B', fontWeight:600, marginBottom:6, textTransform:'uppercase', letterSpacing:'0.5px' }}>Email Address</label>
          ...
          <div style={{ marginBottom:20 }}>
            <label style={{ display:'block', fontSize:11, color:'#64748B', fontWeight:600, marginBottom:6, textTransform:'uppercase', letterSpacing:'0.5px' }}>Password</label>
            <div style={{ position:'relative' }}>
          ...
          <div style={{ marginTop:16, padding:'12px 14px', background:'rgba(37,99,235,0.06)',
            ...
            <div style={{ fontSize:11, color:'#2563EB', fontWeight:700, marginBottom:6 }}>🔑 DEMO CREDENTIALS</div>
        ...
        <div style={{ textAlign:'center', marginTop:20 }}>
          <a href="/" style={{ fontSize:13, color:'#64748B', textDecoration:'none' }}>← Back to Admin Login</a>
        </div>
      </div>
    </div>
  );
